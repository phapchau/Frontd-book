<template>
    <Form @submit="submitContact" :validation-schema="contactFormSchema">
        <div class="form-group">
            <label for="manv">Mã độc giả </label>
            <Field name="madocgia" type="text" class="form-control" v-model="contactLocal.madocgia" />
            <ErrorMessage name="manv" class="error-feedback" />
        </div>

        <div class="form-group">
            <label>Họ lót độc giả</label>
        ...
        <div class="form-group">
            ...
            <Field name="tendocgia" type="text" class="form-control" v-model="contactLocal.tendocgia" />
        ...
        <div class="form-group">
            <label>Sex </label>
            <Field name="sex" type="text" class="form-control" v-model="contactLocal.sex" />
